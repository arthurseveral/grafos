...
public class Graph<T> {
    ...
    public void addVertex(T label) {
        vertexs.add(new Vertex<T>(label));
    }
    
    public void bind(T label01, T label02) {
        Integer index01 = vertexs.indexOf(new Vertex<T>(label01));
        Integer index02 = vertexs.indexOf(new Vertex<T>(label02));
    ...
    public List<Vertex<T>> getNeighbors(T label) {
        Integer index = getVertexs().indexOf(new Vertex<T>(label));
